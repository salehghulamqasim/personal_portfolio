...
class _HackathonBoxState extends State<HackathonBox> {
  ...
  final Map<String, Map<String, dynamic>> _hackathons = {
    ...
    '3': {
      'name': 'Tech Meetup 3',
      'project': 'Majid BootCamp, Google Developer Groups',
      ...
      'team': '4 Members',
      'duration': '3 Days',
      'imagePath': 'assets/Certificates/techmeetup.webp',
    },
    '4': {
                            ...
                            builder: (context) {
                              ...
                              return SizedBox(
                                ...
                                child: PageView(
                                  children: [
                                    _ZoomableAssetImage(
                                      path: 'assets/Certificates/gdsc.webp',
                                      height: isMobile ? 260.h : 380.h,
                                      borderRadius: BorderRadius.circular(20.r),
                                      borderColor: const Color(
                                        0xFF4ECDC4,
                                      ).withOpacity(0.2),
                                      placeholderIconColor: const Color(
                                        0xFF4ECDC4,
                                      ),
                                      label: 'GDSC Certificate - Image 1',
                                    ),
                                    _ZoomableAssetImage(
                                      path: 'assets/Certificates/gdsc2.webp',
                                      height: isMobile ? 260.h : 380.h,
                                      borderRadius: BorderRadius.circular(20.r),
                                      borderColor: const Color(
                                        0xFF4ECDC4,
                                      ...
                                      label: 'GDSC Certificate - Image 2',
                                    ),
                                  ],
                                ),
                              );
                            ...
                            builder: (context) {
                              ...
                              return SizedBox(
                                ...
                                child: PageView(
                                  children: [
                                    _ZoomableAssetImage(
                                      path: 'assets/Certificates/iftar.webp',
                                      height: isMobile ? 260.h : 380.h,
                                      borderRadius: BorderRadius.circular(20.r),
                                      borderColor: const Color(
                                        0xFF4ECDC4,
                                    ...
                                    _ZoomableAssetImage(
                                      path: 'assets/Certificates/iftar2.webp',
                                      height: isMobile ? 260.h : 380.h,
                                      borderRadius: BorderRadius.circular(20.r),
                                      borderColor: const Color(
                                        0xFF4ECDC4,
                                      ...
                                      label:
                                          'Additional certificate for Iftar event',
                                    ),
                                  ],
                                ),
                              );
